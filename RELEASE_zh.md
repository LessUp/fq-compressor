...
| Linux x64 (Clang) | `fq-compressor-v0.1.0-linux-x86_64-clang.tar.gz` | Clang 22 + libc++ | 动态链接 |
...
| Linux arm64 (Clang) | `fq-compressor-v0.1.0-linux-aarch64-clang.tar.gz` | Clang 22 + libc++ | 动态链接 |
