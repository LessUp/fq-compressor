...
**Key highlights:**
- 🧪 **Evidence-first benchmarking** via `./scripts/benchmark_v2.sh` with JSON + Markdown conclusions
...
- **Latest benchmark evidence** is generated by `./scripts/benchmark_v2.sh` as JSON + Markdown reports
...
```
Generate reproducible benchmark evidence with:
