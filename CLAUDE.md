...
**待完善**:
- ⚠️ `vendor/spring-core/` Spring ABC 算法集成（当前 CMakeLists.txt 中已注释）
- ⚠️ `--original-order` 功能完善（当前为预留功能）
...
A: **项目自研代码采用 MIT 许可证**；仓库中的 `vendor/spring-core/` 保留 Spring 原始的非商业研究用途许可证，且当前默认构建未启用该目录。若重新分发或商业使用该 vendored 代码，需要额外核对其许可条款。
...
| 日期 | 操作 | 说明 |
|------|------|------|
| 2026-04-16 | 文档优化 | 整合 changelog 目录到 CHANGELOG.md，修复 CI workflow 问题 |
| 2026-03-22 | 功能完善 | Original-order decompression MVP，许可证对齐 |
